...
public class GetInterestsRequestTest {
    ...
    public void willGenerateAnXmppStanza() throws Exception {
        ...
        assertThat(request.toXML().toString(), isIdenticalTo(GetInterestsFixtures.GET_INTERESTS_REQUEST).ignoreWhitespace());
    }

    @Test
    public void willParseAnXmppStanza() throws Exception {

    	final GetInterestsRequest request = PacketParserUtils.parseStanza(GetInterestsFixtures.GET_INTERESTS_REQUEST);
        assertThat(request.getStanzaId(), is(CoreFixtures.STANZA_ID));
        assertThat(request.getTo(), is(Fixtures.TO_JID));
        assertThat(request.getFrom(), is(Fixtures.FROM_JID));
    ...
    public void willReturnParsingErrors() throws Exception {
        ...
        final GetInterestsRequest request = PacketParserUtils.parseStanza(GetInterestsFixtures.GET_INTERESTS_REQUEST_WITH_BAD_VALUES);
...
//               "Invalid stanza; missing or incorrect 'type' attribute",
    ...
    public void willGenerateAStanzaEvenWithParsingErrors() throws Exception {
        ...
        assertThat(request.toXML().toString(), isIdenticalTo(GetInterestsFixtures.GET_INTERESTS_REQUEST_WITH_BAD_VALUES).ignoreWhitespace());
    }
