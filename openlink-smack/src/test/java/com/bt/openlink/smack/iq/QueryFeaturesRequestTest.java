...
public class QueryFeaturesRequestTest {
    ...
    public void willGenerateAnXmppStanza() throws Exception {
        ...
        assertThat(request.toXML().toString(), isIdenticalTo(QueryFeaturesFixtures.QUERY_FEATURES_REQUEST).ignoreWhitespace());
    }

    @Test
    public void willParseAnXmppStanza() throws Exception {

        final QueryFeaturesRequest request = PacketParserUtils.parseStanza(QueryFeaturesFixtures.QUERY_FEATURES_REQUEST);
        assertThat(request.getStanzaId(), is(CoreFixtures.STANZA_ID));
        assertThat(request.getTo(), is(Fixtures.TO_JID));
        assertThat(request.getFrom(), is(Fixtures.FROM_JID));
    ...
    public void willReturnParsingErrors() throws Exception {
        ...
        final QueryFeaturesRequest request = PacketParserUtils.parseStanza(QueryFeaturesFixtures.QUERY_FEATURES_REQUEST_WITH_BAD_VALUES);
    ...
    public void willGenerateAStanzaEvenWithParsingErrors() throws Exception {
        ...
        assertThat(request.toXML().toString(), isIdenticalTo(QueryFeaturesFixtures.QUERY_FEATURES_REQUEST_WITH_BAD_VALUES).ignoreWhitespace());
