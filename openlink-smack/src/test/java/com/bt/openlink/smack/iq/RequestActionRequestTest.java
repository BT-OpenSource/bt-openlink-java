...
public class RequestActionRequestTest {
    ...
    @Test
    public void willGenerateAnXmppStanzaWithFeatures() throws Exception {
        ...
        assertThat(request.toXML().toString(), isIdenticalTo(RequestActionFixtures.REQUEST_ACTION_REQUEST_WITH_FEATURES).ignoreWhitespace());
    }

    @Test
    public void willParseAnXmppStanzaWithFeatures() throws Exception {

        final RequestActionRequest request = PacketParserUtils.parseStanza(RequestActionFixtures.REQUEST_ACTION_REQUEST_WITH_FEATURES);
        assertThat(request.getTo(), is(Fixtures.TO_JID));
        assertThat(request.getFrom(), is(Fixtures.FROM_JID));
        assertThat(request.getType(), is(IQ.Type.set));
        assertThat(request.getAction().get(), is(RequestAction.START_VOICE_DROP));
