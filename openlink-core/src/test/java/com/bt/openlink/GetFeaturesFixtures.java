...
public class GetFeaturesFixtures {
    ...
    public static final String GET_FEATURES_RESULT = "<iq type=\"result\" id=\"" + CoreFixtures.STANZA_ID + "\" to=\"" + CoreFixtures.TO_JID_STRING + "\" from=\"" + CoreFixtures.FROM_JID_STRING + "\">\n" +
    ...
    public static final String GET_FEATURES_RESULT_WITH_BAD_VALUES = "<iq type=\"get\">\n" +
            "  <command xmlns=\"http://jabber.org/protocol/commands\" action=\"execute\" node=\"http://xmpp.org/protocol/openlink:01:00:00#get-features\">\n" +
            "    <iodata xmlns=\"urn:xmpp:tmp:io-data\" type=\"output\">\n" +
            "      <out>\n" +
            "      </out>\n" +
