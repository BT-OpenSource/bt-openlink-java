...
public class GetInterestsRequestBuilderTest {

    private static class Builder extends GetInterestsRequestBuilder<Builder, String, CoreFixtures.typeEnum> {
        protected Builder() {
    ...
    public void willCheckThatTheProfileIsSet() throws Exception {
        ...
        assertThat(errors, contains("Invalid get-interests request stanza; missing 'profile'"));
