...
public class PubSubSubscribeRequestBuilderTest {
    private static class Builder extends PubSubSubscribeRequestBuilder<Builder, String, Fixtures.typeEnum> {
        protected Builder() {
    ...
    public void willCheckMandatoryFields() throws Exception {
        ...
        assertThat(errors, contains(
                "Invalid pub-sub subscribe request stanza; missing node id/interest id",
                "Invalid pub-sub subscribe request stanza; missing jid"
        ));
    }
}