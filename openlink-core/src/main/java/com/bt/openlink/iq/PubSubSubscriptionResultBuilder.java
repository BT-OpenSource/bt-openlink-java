...
public abstract class PubSubSubscriptionResultBuilder<B extends PubSubSubscriptionResultBuilder, J, T extends Enum<T>> extends IQBuilder<B, J, T> {

    @Nullable private PubSubNodeId pubSubNodeId;
    @Nullable private J jid;
    @Nullable private SubscriptionState subscriptionState;

    protected PubSubSubscriptionResultBuilder(final Class<T> typeClass) {
        super(typeClass);
    }
